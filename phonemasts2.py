...
with open("jay4digital.github.io/MobilePhoneMasts.csv.sjtmdl") as file:  #opens csv file to be used
    for line in file:
...
def addentry(sortedlist,entry):                #adding entry to sortedlist and display in browser
    ...
    with open("jay4digital.github.io/latestlist.txt", "a") as my_file:  # a textfile called latestlist is then opened and renamed in append(a) mode which retains every entry added
